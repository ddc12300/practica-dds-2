...
links_url <- xpathSApply(contenido_xml, "//a", xmlGetAttr, "href")
...
df_enlaces <- data.frame(Texto = links_text, URL = links_url, stringsAsFactors = FALSE)

# Reemplazar los valores NULL por NA en el data frame
df_enlaces[is.na(df_enlaces)] <- NA
